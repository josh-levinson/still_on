...
- [ ] **"Add to calendar" on guest RSVP page** — after a guest confirms attendance, there's no way to get the event into their calendar. An ICS download or Google Calendar link would reduce no-shows.
